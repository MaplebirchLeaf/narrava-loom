...
use crate::{
    ...
    hir::{HirMacroArguments, OwnedHirMacro, OwnedHirMacroArguments},
    i18n::I18nCatalog,
    lir::LirProgram,
    mir::{MirI18nTextPart, MirInstruction, MirInstructionPointer, MirMacroBody, MirPassageId},
};
...
pub enum BytecodeOperation {
    Text {
        text: String,
        output: crate::mir::MirOutputMode,
    ...
    InvokeMacro {
        ...
        syntax_kind: crate::twee::MacroSyntaxKind,
        captures: Vec<String>,
        output: crate::mir::MirOutputMode,
    },
    ExitPassage,
    Evaluate {
        destination: crate::mir::MirValueSlot,
    },
    PrepareCollectionIteration {
        kind: crate::mir::MirCollectionIterationKind,
        destination: crate::mir::MirIteratorSlot,
    },
    PrepareRangeIteration {
        has_step: bool,
        destination: crate::mir::MirIteratorSlot,
    ...
    NextIteration {
        iterator: crate::mir::MirIteratorSlot,
        exhausted: crate::mir::MirInstructionPointer,
    },
    JumpIfFalse {
        target: crate::mir::MirInstructionPointer,
    },
    JumpIfNotStrictEqual {
        left: crate::mir::MirValueSlot,
        target: crate::mir::MirInstructionPointer,
    },
    Jump {
        target: crate::mir::MirInstructionPointer,
...
impl BytecodeOperation {
    fn from_mir(instruction: &MirInstruction<'_, '_>) -> Self {
        match instruction {
            MirInstruction::Text {
                text,
                output,
    ...
    fn jump_target(&self) -> Option<MirInstructionPointer> {
        match self {
    ...
    fn value_slot(&self) -> Option<crate::mir::MirValueSlot> {
        match self {
    ...
    fn iterator_slot(&self) -> Option<crate::mir::MirIteratorSlot> {
        match self {
...
impl BytecodeMacroArguments {
    fn matches_owned(&self, value: &OwnedHirMacroArguments) -> bool {
        match (self, value) {
...
fn own_expressions(instruction: &MirInstruction<'_, '_>) -> Vec<OwnedExpression> {
