...
declare global {
  ...
  type NarravaHostDebugSnapshotDto = { readonly evaluation: NarravaHostDebugEvaluationDto | null; readonly current: string | null; readonly state: unknown; readonly location: unknown; readonly truncated: boolean; readonly logs: readonly NarravaHostLogRecordDto[] }
