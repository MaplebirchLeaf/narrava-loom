...
declare global {
  ...
  type NarravaRuntimeCommand = { readonly type: "start" } | { readonly type: "activate"; readonly interaction: string } | { readonly type: "input"; readonly interaction: string; readonly value: unknown } | { readonly type: "save"; readonly operation: NarravaRuntimeSaveOperation; readonly target: string } | { readonly type: "selectLanguage"; readonly locale: string } | { readonly type: "resume"; readonly operation: number; readonly result?: NarravaPendingResult } | { readonly type: "cancel"; readonly operation: number }
  ...
  type NarravaRuntimeUpdate = { readonly type: "ready"; readonly update: { readonly current: string; readonly nodes: readonly unknown[] } } | { readonly type: "applied" } | { readonly type: "pending"; readonly operation: NarravaPendingOperation }
