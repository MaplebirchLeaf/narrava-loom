...
当前版本为 `0.1.0`：首个可构建、可测试的开发基线。它用于继续完善引擎和 Host，尚不承诺
...
[Host 与 Presentation](docs/architecture/host-presentation.md)。
...
Host Presentation、I18n fallback、Save 数据模型、Resource、Event，以及 Script Bundle 与脚本调用契约。
